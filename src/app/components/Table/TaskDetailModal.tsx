...
const TaskDetailModal = ({
  ...
  const handleChecklistItem = () => {
    ...
    if (selection && editorRef.current) {
      ...
      checkbox.className = "mr-2 rounded-full";
      checkbox.onclick = (e) => {
      ...
      span.textContent = selection.toString() || "New item";
          ...
          {!isEditing ? (
            ...
            <div className="border rounded-lg p-4">
              ...
              <div
                ref={editorRef}
                contentEditable
                className="min-h-[8rem] max-h-[20rem] overflow-y-auto p-2 border rounded focus:outline-none focus:border-blue-500 empty:before:content-[attr(data-placeholder)] empty:before:text-gray-400"
