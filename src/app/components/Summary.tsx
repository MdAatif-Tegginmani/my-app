...
const Summary = () => {
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-800   rounded-lg p-6 shadow-sm mobile:p-4 ">
        <h2 className="text-xl text-[#622BD9] opacity-80 dark:text-white font-semibold mb-4 mobile:text-base">Summary</h2>
          ...
          <div className="flex justify-between items-center  mobile:justify-center">
            <div className="mr-10 mobile:w-auto  ">
              <div className=" border border-gray-200 rounded-lg p-4 mobile:h-auto">
                <h3 className="text-sm text-gray-500 dark:text-[#c0c3cd]  mobile:text-xs">Money In</h3>
                <p className="text-lg font-semibold text-purple-500 mobile:text-sm">$2.4k</p>
              </div>
              <div className=" border border-gray-200 rounded-lg p-4 mobile:h-auto">
                <h3 className="text-sm text-gray-500 dark:text-[#c0c3cd]  mobile:text-xs  ">Money Out</h3>
                <p className="text-lg font-semibold text-purple-500 mobile:text-sm">$2.4k</p>
              </div>
            </div>
              <div className=" border border-gray-200 rounded-lg p-4 mobile:w-auto">
                <h3 className="text-sm text-gray-500 dark:text-[#c0c3cd]   mobile:text-xs">Current Balance</h3>
